...
const BookingRow = ({booking, appointment, transaction, client}) => {
  
    console.log("IN BOOKING ROW BOOKING")
    console.log(booking)
    console.log("IN BOOKING ROW APPT")
    console.log(appointment)
    console.log("IN THE BOOKING ROW 1234")
